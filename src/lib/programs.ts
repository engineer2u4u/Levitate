...
export const programs: Program[] = [
  ...
  { id: "hredge", slug: "hr-edge", num: "06", tag: "For Students", short: "HR Edge Certification (for students)", title: "HR Edge Certification (for students)", sub: "Integrated DEI, POSH & Workplace Wellbeing Trainer Certification for Future HR Professionals",
