...
export type ServicePageData = {
  ...
  listHeading: string;
  listGrid: string;
  /** `href` turns a card into a link — the certification pathways open their
   *  own program page; other services list items that are not pages. */
  items: { num: string; t: string; d: string; href?: string }[];
...
export const PAGES: Record<ServiceKey, ServicePageData> = {
  ttt: {
    ...
    lede: "Practice-led workplace facilitator certifications in Corporate Leadership Facilitation, Diversity, Equity, Inclusion & Belonging, Applied Workplace Mental Health & Wellbeing, PoSH and POCSO — along with HR Edge certification for future HR professionals.",
    ...
    intro: [
      ...
      "Certification is awarded after successful completion of the program requirements, including live participation and completion of the final assessment.",
    ],
    ...
    items: [
      {
        num: "01",
        t: "Corporate Leadership Facilitator Program (CLF TTT)",
        href: "/lms/course/leadership-facilitator",
        d: "Powered by the HUMAN Leadership Framework Train-the-Trainer Certification — facilitate leadership conversations on trust, coaching, feedback, accountability and team growth.",
      },
      {
        num: "02",
        t: "Inclusive Workplace Facilitator Program (DEIB TTT)",
      ...
      {
        num: "05",
        t: "POCSO & Child Safety Facilitator Program (POCSO TTT)",
        href: "/lms/course/pocso-child-safety",
        d: "Powered by the GUARD CHild Saftey Framework Train-the-Trainer Certification — age-appropriate, institution-sensitive child-safety sessions and responsible reporting conversations.",
      },
      {
        num: "06",
        t: "HR Edge certification (HR Students)",
        href: "/lms/course/hr-edge",
        d: "Powered by the EDGE Rediness Framework Train-the-Trainer Certification Integrated DEIB, PoSH & Workplace Wellbeing for MBA-HR, PGDM-HR students and early-career HR professionals.",
      },
    ],
    ...
    certBody: "On successful completion, participants receive a Levitate PeopleSoft facilitator certificate naming the specific pathway completed, with a unique verification ID.",
    ...
    certProgram: "Corporate Leadership Facilitator Program (CLF TTT)",
    ...
    options: ["Corporate Leadership", "DEIB", "Wellbeing", "PoSH", "POCSO", "HR Edge", "Not sure yet"],
    ...
    faqs: [
      ...
      {
        q: "Can I become a corporate trainer after this?",
        a: "Yes — that is the point. You leave with a facilitator guide, slide master, case pack, certificate and session plans for the pathway you complete.",
      },
    ],
  },
  corporate: {
    ...
    img: "/assets/corporate-hero.jpeg",
    facts: [{ k: "Delivery", v: "Online and Blended Learning" }],
    ...
    items: [
      ...
      { num: "07", t: "Diversity, Equity, Inclusion & Belonging", d: "Inclusive leadership, unconscious bias, respectful behaviour, gender sensitivity, belonging, allyship and everyday workplace inclusion." },
    ],
    ...
    options: ["Leadership & managers", "Communication", "Collaboration & culture", "Wellbeing", "DEIB", "PoSH", "Multiple areas"],
  ...
  institutional: {
    ...
    items: [
      ...
      { num: "05", t: "HR Edge certification (HR Students)", d: "An integrated certification for MBA-HR, PGDM-HR and HR postgraduate students combining DEIB, PoSH and workplace wellbeing." },
    ],
    ...
    certBody:
      "Students receive a certificate naming the program completed. For MBA-HR and PGDM-HR cohorts, the HR Edge certification records an applied, assessment-based credential in DEIB, PoSH and workplace wellbeing — a genuine differentiator in HR interviews.",
    certLabel: "HR Edge certification (HR Students)",
    certName: "Student Name",
    certLine1: "This certifies that",
    certLine2: "has successfully completed the",
    certLine3: "integrated DEIB, PoSH and workplace wellbeing curriculum with assessment",
  ...
  advisory: {
    ...
    formSub: "Partner with Levitate PeopleSoft to strengthen your HR practices, workplace culture and people capability with practical, experience-led support.",
    orgLabel: "Organization *",
