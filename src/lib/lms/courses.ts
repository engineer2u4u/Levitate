...
export const COURSES: Course[] = [
  ...
  {
    slug: "hr-edge",
    tag: "For students", mode: "Live online · 6 weeks",
    title: "HR EDGE — Certified MNC-Ready HR Practitioner Programme",
    short: "HR EDGE",
    desc: "Think like an HR Business Partner: business understanding, manager conversations and people decisions, built on the EDGE Framework.",
    img: "/assets/students-group.png", status: "waitlist",
    feePaise: null, priceNote: "institutional pricing available",
    modulesLabel: "8 modules", hoursLabel: "42 learning hours", facilitator: "Parichita Kotnala",
    certificate: {
      name: "HR EDGE — Certified MNC-Ready HR Practitioner Programme",
      closing: "as a **Certified MNC-Ready HR Practitioner**, built on the EDGE Framework.",
      hours: "42 Hours",
    },
  },
  {
