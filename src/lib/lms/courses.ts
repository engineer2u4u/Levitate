...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    short: "HR Edge",
    desc: "Integrated DEIB, PoSH and wellbeing certification for MBA-HR and early-career HR professionals.",
    ...
    certificate: {
      ...
      closing: "in integrated **DEIB, PoSH & Workplace Wellbeing** facilitation.",
      hours: "12 Hours",
    },
  },
  {
