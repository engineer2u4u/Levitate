      ...
      items: [
        {
          ...
          body: [
            ...
            "A reading is finished by reading it: the Proceed button appears once you reach the end of the page. A film is finished by watching it. A quiz is finished by passing it — each one states its pass mark, 70% of its questions — and a lower score sends you back over the material rather than on. Only whether you passed is kept; the score itself is not.",
        ...
        },
        {
          ...
          questions: [
            ...
            },
            {
              ...
              options: [
                "Reaching the pass mark shown under the questions",
                "Submitting it, whatever the score",
                "Opening it",
                "Nothing — quizzes are optional",
              ],
              answer: 0,
              explanation: "The pass mark is 70% of the questions, to the nearest whole question, and each quiz states its own. A score below the mark leaves the item open so you can retake it, and nothing but the pass is recorded.",
            },
            {
