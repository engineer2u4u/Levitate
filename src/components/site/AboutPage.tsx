...
const pkTags = ["Leadership enablement", "Workplace culture", "DEIB", "PoSH & POCSO", "Wellbeing", "People advisory"];
...
const accred = [
  ...
  { badge: "HR EDGE", t: "HR Edge Curriculum", d: "Integrated DEIB, PoSH and wellbeing certification for future HR professionals." },
];
const gallery = [
        ...
        <div className="site-stack" style={{ maxWidth: 1240, margin: "0 auto", display: "grid", gridTemplateColumns: "1.15fr .85fr", gap: 64, alignItems: "start" }}>
          <Reveal>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, font: "400 15.5px/1.8 'Plus Jakarta Sans',sans-serif", color: "#5b6e82" }}>
              ...
              <p style={{ margin: 0, textWrap: "pretty" } as CSSProperties}>
                We specialize in Train-the-Trainer certification programs, workplace facilitator development, corporate training and HR capability-building solutions across leadership, DEIB, workplace
              ...
              <div style={{ padding: "40px 44px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12, font: "400 14.5px/1.75 'Plus Jakarta Sans',sans-serif", color: "#5b6e82" }}>
                  <p style={{ margin: 0, textWrap: "pretty" } as CSSProperties}>
                    ...
                    partnering, leadership enablement, performance, employee relations, workplace compliance, PoSH, POCSO, wellbeing, DEIB and people advisory.
                  </p>
                  <p style={{ margin: 0, textWrap: "pretty" } as CSSProperties}>
