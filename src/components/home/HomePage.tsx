  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", bottom: 26, right: 26, zIndex: 90, display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ background: "#fff", color: "#0a1b33", font: "600 12px/1.3 'Manrope',sans-serif", padding: "8px 14px", borderRadius: 10, border: "1px solid rgba(47,196,188,.45)", boxShadow: "0 8px 24px rgba(10,27,51,.14)" }}>
          Chat with us on WhatsApp
        </div>
        <a href={contact.whatsapp} aria-label="Chat on WhatsApp" style={{ width: 54, height: 54, borderRadius: "50%", background: "#25d366", display: "flex", alignItems: "center", justifyContent: "center", animation: "pulse 2.6s infinite", boxShadow: "0 10px 26px rgba(10,27,51,.25)" }}>
      ...
      {/* TOP CONTACT BAR */}
      <div style={{ background: "#fff", borderBottom: "1px solid #e3eaf0", padding: "8px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", rowGap: 6, columnGap: 16, lineHeight: 1.5, font: "500 12.5px/1.5 'Manrope',sans-serif", color: "#5b6e82" }}>
        <div style={{ display: "flex", gap: 22, flexWrap: "wrap" }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 7 }}><MailIcon />{contact.email}</span>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 7 }}><PhoneIcon />{contact.phone}</span>
        </div>
      ...
      {/* STICKY HEADER */}
      <div style={{ position: "sticky", top: 0, zIndex: 80, background: "rgba(255,255,255,.85)", backdropFilter: "blur(14px)", borderBottom: "1px solid #e3eaf0", padding: "14px 48px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 14 }}>
        ...
        <a href="#" className="lp-btn-grad" style={{ background: "linear-gradient(120deg,#2fc4bc,#2f7fd6)", color: "#04121f", font: "700 13.5px 'Manrope',sans-serif", padding: "11px 22px", borderRadius: 999, whiteSpace: "nowrap" }}>
      ...
      <div data-screen-label="Hero" style={{ position: "relative", overflow: "hidden", background: "#eef4f7", padding: "110px 48px", minHeight: "72vh", display: "flex", alignItems: "center" }}>
        <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
          <img src="/assets/founder-speaking.jpeg" alt="Founder video background" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", animation: "kenburns 24s ease-in-out infinite", willChange: "transform" }} />
        ...
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto", width: "100%", display: "grid", gridTemplateColumns: "1.25fr .75fr", gap: 64, alignItems: "center" }}>
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, border: "1px solid rgba(27,143,136,.45)", color: "#1b8f88", font: "600 12px 'Manrope',sans-serif", letterSpacing: ".16em", textTransform: "uppercase", padding: "8px 16px", borderRadius: 999, marginBottom: 26, background: "rgba(255,255,255,.6)" }}>
            ...
            <h1 style={{ font: "700 clamp(40px,4.6vw,62px)/1.08 'Space Grotesk',sans-serif", color: "#0a1b33", margin: "0 0 24px", letterSpacing: "-.02em" }}>
              Elevating Trainers.<br />Transforming Workplaces.<br />
            ...
            <p style={{ font: "400 17px/1.7 'Manrope',sans-serif", color: "#5b6e82", maxWidth: 560, margin: "0 0 36px", textWrap: "pretty" } as CSSProperties}>
              Global content. Practical facilitation. Real workplace application. We design certification programs, corporate learning interventions and institutional training solutions that build high-trust, inclusive and human-centred workplaces.
            </p>
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
              <a href="#" className="lp-btn-grad" style={{ background: "linear-gradient(120deg,#2fc4bc,#2f7fd6)", color: "#04121f", font: "700 15px 'Manrope',sans-serif", padding: "16px 30px", borderRadius: 999, display: "inline-flex", alignItems: "center", gap: 10, whiteSpace: "nowrap", boxShadow: "0 12px 28px rgba(27,143,136,.28)" }}>
                Explore Certification Programs <span>→</span>
              </a>
              <a href="#" className="lp-btn-outline" style={{ border: "1.5px solid rgba(10,27,51,.28)", color: "#0a1b33", font: "700 15px 'Manrope',sans-serif", padding: "16px 30px", borderRadius: 999, whiteSpace: "nowrap", background: "rgba(255,255,255,.6)" }}>
                Book a Discovery Call
              </a>
            </div>
            <div style={{ display: "flex", gap: 40, marginTop: 48 }}>
              <div>
                <div style={{ font: "700 30px 'Space Grotesk',sans-serif", color: "#0a1b33", fontVariantNumeric: "tabular-nums" }}><Counter to={2000} trigger="mount" />+</div>
              ...
              <div>
                <div style={{ font: "700 30px 'Space Grotesk',sans-serif", color: "#0a1b33", fontVariantNumeric: "tabular-nums" }}><Counter to={15} trigger="mount" />+ yrs</div>
              ...
              <div style={{ width: 1, background: "rgba(10,27,51,.14)" }} />
              <div>
                <div style={{ font: "700 30px 'Space Grotesk',sans-serif", color: "#0a1b33" }}>4.9<span style={{ color: "#f5b942", fontSize: 20 }}> ★</span></div>
          ...
          <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 22 }}>
            <div style={{ position: "relative", width: 190, height: 190, display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <div onClick={() => setVideoOpen(true)} className="lp-video-btn" style={{ width: 110, height: 110, borderRadius: "50%", background: "linear-gradient(135deg,#2fc4bc,#2f7fd6)", display: "flex", alignItems: "center", justifyContent: "center", animation: "pulse 2.4s infinite", cursor: "pointer" }}>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ font: "500 13px 'Manrope',sans-serif", color: "#5b6e82", marginTop: 5 }}>
                Why we build certified workplace facilitators<br />
      ...
      {/* VIDEO MODAL */}
      {videoOpen && (
        <div onClick={() => setVideoOpen(false)} style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(10,27,51,.55)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 48, animation: "fadeUp .3s ease" }}>
          <div onClick={(e) => e.stopPropagation()} style={{ position: "relative", width: "min(960px,100%)", aspectRatio: "16/9", background: "#050d1a", border: "1px solid rgba(47,196,188,.4)", borderRadius: 18, overflow: "hidden", boxShadow: "0 40px 120px rgba(10,27,51,.45)" }}>
            ...
            <div onClick={() => setVideoOpen(false)} className="lp-close-btn" style={{ position: "absolute", top: 14, right: 14, width: 40, height: 40, borderRadius: "50%", background: "rgba(255,255,255,.1)", border: "1px solid rgba(255,255,255,.25)", color: "#fff", font: "600 18px 'Manrope',sans-serif", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
              ✕
            </div>
          </div>
        </div>
      ...
      {/* TICKER */}
      <div style={{ background: "#fff", borderTop: "1px solid rgba(27,143,136,.2)", borderBottom: "1px solid rgba(27,143,136,.2)", overflow: "hidden", padding: "18px 0", position: "relative", maskImage: "linear-gradient(90deg,transparent,#000 8%,#000 92%,transparent)", WebkitMaskImage: "linear-gradient(90deg,transparent,#000 8%,#000 92%,transparent)" }}>
        <div style={{ display: "flex", width: "max-content", animation: "marquee 32s linear infinite", gap: 14, marginBottom: 12 }}>
          {[...tickerA, ...tickerA].map((t, i) => (
            <div key={`a${i}`} className="lp-tick-a" style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 20px", border: "1px solid rgba(27,143,136,.3)", borderRadius: 999, background: "rgba(47,196,188,.07)", font: "600 13.5px 'Space Grotesk',sans-serif", color: "#0a1b33", whiteSpace: "nowrap" }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "linear-gradient(135deg,#2fc4bc,#2f7fd6)" }} />{t}
            </div>
          ))}
        </div>
        <div style={{ display: "flex", width: "max-content", animation: "marqueeRev 38s linear infinite", gap: 14 }}>
          {[...tickerB, ...tickerB].map((t, i) => (
            <div key={`b${i}`} className="lp-tick-b" style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 20px", border: "1px solid rgba(47,127,214,.3)", borderRadius: 999, background: "rgba(47,127,214,.06)", font: "600 13.5px 'Space Grotesk',sans-serif", color: "#5b6e82", whiteSpace: "nowrap" }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "linear-gradient(135deg,#5aa9f2,#2fc4bc)" }} />{t}
            </div>
          ))}
        </div>
      </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <Reveal style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 32, flexWrap: "wrap", marginBottom: 52 }}>
            <div>
              ...
              <h2 style={{ font: "700 clamp(30px,3.2vw,44px)/1.15 'Space Grotesk',sans-serif", color: "#0a1b33", margin: 0, letterSpacing: "-.02em", maxWidth: 640 }}>Learning, certification and capability-building for modern workplaces</h2>
            </div>
            <p style={{ font: "400 15.5px/1.7 'Manrope',sans-serif", color: "#5b6e82", maxWidth: 400, margin: 0 }}>We work with professionals, organizations and institutions across four core verticals.</p>
          </Reveal>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 26, perspective: 1400 }}>
            {services.map((s) => (
              <Reveal key={s.num} className="lp-svc-card" onMouseMove={tiltMoveDeep} onMouseLeave={tiltLeave} style={{ position: "relative", background: "linear-gradient(165deg,#ffffff,#f2f7fa)", border: "1px solid #e3eaf0", borderRadius: 20, padding: "32px 26px 26px", display: "flex", flexDirection: "column", gap: 14, transformStyle: "preserve-3d", boxShadow: "0 1px 2px rgba(10,27,51,.06),0 10px 24px rgba(10,27,51,.08),0 30px 60px -18px rgba(10,27,51,.18)" }}>
                ...
                <div style={{ width: 56, height: 56, borderRadius: 16, background: "linear-gradient(135deg,#2fc4bc,#2f7fd6)", display: "flex", alignItems: "center", justifyContent: "center", font: "700 19px 'Space Grotesk',sans-serif", color: "#fff", boxShadow: "0 10px 22px rgba(27,143,136,.35)", transform: "translateZ(36px)" }}>{s.num}</div>
                ...
                <a href="#" style={{ font: "700 13.5px 'Manrope',sans-serif", color: "#1b8f88", transform: "translateZ(26px)" }}>Explore →</a>
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <div data-screen-label="Blueprint" style={{ background: "#fff", padding: "96px 48px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <Reveal style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ font: "700 clamp(28px,3vw,40px)/1.15 'Space Grotesk',sans-serif", color: "#0a1b33", margin: 0, letterSpacing: "-.02em" }}>Learning that begins with context<br />and ends with workplace application</h2>
          </Reveal>
          <Reveal style={{ display: "grid", gridTemplateColumns: "380px 1fr", gap: 28, alignItems: "stretch" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {blueprintSteps.map((b, i) => {
                const on = i === step;
                return (
                  <div key={b.num} onClick={() => selectStep(i)} style={{ display: "flex", alignItems: "center", gap: 16, padding: "18px 20px", borderRadius: 16, cursor: "pointer", background: on ? "linear-gradient(120deg,#2fc4bc,#2f7fd6)" : "#f4f7f9", border: `1px solid ${on ? "rgba(27,143,136,.5)" : "#e3eaf0"}`, transition: "background .3s ease,border-color .3s ease,transform .3s ease", transform: on ? "translateX(8px)" : "translateX(0)" }}>
                    <div style={{ width: 46, height: 46, flex: "none", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", font: "700 17px 'Space Grotesk',sans-serif", background: on ? "rgba(255,255,255,.22)" : "#e3ecf2", color: on ? "#fff" : "#5b6e82", transition: "background .3s ease" }}>{b.num}</div>
                    <div style={{ flex: 1 }}>
            ...
            <div style={{ position: "relative", borderRadius: 22, overflow: "hidden", background: "#eef4f7", border: "1px solid #e3eaf0", minHeight: 420 }}>
              ...
              <div style={{ position: "absolute", right: -20, bottom: -50, font: "700 260px 'Space Grotesk',sans-serif", color: "rgba(27,143,136,.09)", lineHeight: 1, pointerEvents: "none" }}>{activeStep.num}</div>
              <div style={{ position: "relative", padding: "52px 54px", display: "flex", flexDirection: "column", height: "100%", boxSizing: "border-box", justifyContent: "center", gap: 18 }}>
                <div style={{ display: "inline-flex", alignSelf: "flex-start", alignItems: "center", gap: 10, border: "1px solid rgba(27,143,136,.45)", borderRadius: 999, padding: "7px 16px", font: "700 11.5px 'Manrope',sans-serif", color: "#1b8f88", letterSpacing: ".16em", textTransform: "uppercase", whiteSpace: "nowrap" }}>Step {activeStep.num} of 4</div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginTop: 6 }}>
                  {activeStep.chips.map((ch) => (
                    <div key={ch} style={{ background: "rgba(47,196,188,.12)", border: "1px solid rgba(27,143,136,.35)", color: "#136f6a", font: "600 12.5px 'Manrope',sans-serif", padding: "7px 14px", borderRadius: 999 }}>{ch}</div>
                  ))}
                </div>
              </div>
            </div>
      ...
      <div data-screen-label="Certifications" style={{ position: "relative", background: "#f7fafc", padding: "96px 48px", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: -180, right: -120, width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle,rgba(47,127,214,.1),transparent 65%)", filter: "blur(30px)" }} />
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto" }}>
          <Reveal style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 32, flexWrap: "wrap", marginBottom: 52 }}>
            <div>
              ...
              <h2 style={{ font: "700 clamp(30px,3.2vw,44px)/1.15 'Space Grotesk',sans-serif", color: "#0a1b33", margin: 0, letterSpacing: "-.02em", maxWidth: 620 }}>Choose your certification pathway</h2>
            </div>
            <p style={{ font: "400 15.5px/1.7 'Manrope',sans-serif", color: "#5b6e82", maxWidth: 420, margin: 0 }}>For HR professionals, L&amp;D leaders, educators, consultants, coaches, managers and aspiring corporate trainers.</p>
          </Reveal>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22 }}>
            {certs.map((c) => (
              <Reveal key={c.num} className="lp-cert-card" onMouseMove={tiltMove} onMouseLeave={tiltLeave} style={{ background: "#fff", border: "1px solid #e3eaf0", borderRadius: 18, padding: "28px 26px", display: "flex", flexDirection: "column", gap: 12, boxShadow: "0 2px 6px rgba(10,27,51,.05)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <div style={{ font: "700 11px 'Manrope',sans-serif", color: "#1b8f88", letterSpacing: ".14em", textTransform: "uppercase", border: "1px solid rgba(27,143,136,.4)", borderRadius: 999, padding: "5px 12px" }}>{c.tag}</div>
                ...
                <a href="#" style={{ font: "700 13.5px 'Manrope',sans-serif", color: "#1b8f88" }}>Program details →</a>
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <div data-screen-label="Why Levitate" style={{ background: "#f4f7f9", padding: "96px 48px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <Reveal>
            ...
            <h2 style={{ font: "700 clamp(28px,3vw,40px)/1.15 'Space Grotesk',sans-serif", color: "#0a1b33", margin: "0 0 18px", letterSpacing: "-.02em" }}>Built for professionals who refuse to remain slide-based trainers</h2>
            <p style={{ font: "400 15px/1.7 'Manrope',sans-serif", color: "#5b6e82", margin: "0 0 30px" }}>Our programs help participants become confident, credible and responsible workplace facilitators.</p>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {whyPoints.map((w) => (
                <div key={w.t} style={{ display: "flex", gap: 16, alignItems: "flex-start", background: "#fff", border: "1px solid #e3eaf0", borderRadius: 14, padding: "16px 20px" }}>
                  <div style={{ width: 32, height: 32, flex: "none", borderRadius: "50%", background: "linear-gradient(135deg,#2fc4bc,#2f7fd6)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <Reveal style={{ position: "relative" }}>
            ...
            <div onMouseMove={tiltMove} onMouseLeave={tiltLeave} style={{ position: "relative", background: "#fdfefe", border: "1px solid #dbe5ec", borderRadius: 6, boxShadow: "0 30px 70px rgba(10,27,51,.18)", padding: "38px 42px", transition: "transform .25s ease" }}>
              ...
              <div style={{ textAlign: "center", font: "600 11px 'Manrope',sans-serif", color: "#8296a9", marginTop: 14, fontFamily: "monospace" }}>certificate preview — issued on program completion</div>
            </div>
            <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14, marginTop: 20 }}>
              <div style={{ background: "#fff", border: "1px solid #e3eaf0", borderRadius: 14, padding: "16px 14px", textAlign: "center" }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1b8f88" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" style={{ display: "block", margin: "0 auto" }}><path d="M12 3l7 3v5c0 4.4-3 7.6-7 9-4-1.4-7-4.6-7-9V6l7-3z" /><path d="M9 12l2 2 4-4" /></svg>
              ...
              <div style={{ background: "#fff", border: "1px solid #e3eaf0", borderRadius: 14, padding: "16px 14px", textAlign: "center" }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1b8f88" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" style={{ display: "block", margin: "0 auto" }}><rect x="3" y="5" width="18" height="14" rx="2" /><circle cx="8.5" cy="11" r="2" /><path d="M5.5 16c.6-1.4 1.7-2 3-2s2.4.6 3 2" /><path d="M14 9h5M14 12h5M14 15h3" /></svg>
              ...
              <div style={{ background: "#fff", border: "1px solid #e3eaf0", borderRadius: 14, padding: "16px 14px", textAlign: "center" }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1b8f88" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" style={{ display: "block", margin: "0 auto" }}><rect x="3" y="8" width="18" height="12" rx="2" /><path d="M9 8V6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2" /><path d="M3 13h18" /><path d="M11 13v2h2v-2" /></svg>
      ...
      {/* IMPACT COUNTERS */}
      <div ref={impactRef} data-screen-label="Impact" style={{ background: "linear-gradient(120deg,#e7f5f3,#eaf1fa)", borderTop: "1px solid rgba(27,143,136,.2)", borderBottom: "1px solid rgba(27,143,136,.2)", padding: "64px 48px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 32, textAlign: "center" }}>
          {impactStats.map((st, i) => (
            <div key={st.label} style={{ animation: impactIn ? "popIn .6s ease both" : undefined, animationDelay: impactIn ? `${i * 0.08}s` : undefined }}>
              <div style={{ font: "700 52px 'Space Grotesk',sans-serif", background: "linear-gradient(120deg,#1b8f88,#2f7fd6)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent", fontVariantNumeric: "tabular-nums" }}>
                <Counter to={st.to} dec={st.dec} start={impactIn} />{st.suffix}
              </div>
      ...
      <div data-screen-label="Founders" style={{ background: "#fff", padding: "96px 48px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <Reveal style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ font: "700 clamp(28px,3vw,40px)/1.15 'Space Grotesk',sans-serif", color: "#0a1b33", margin: 0, letterSpacing: "-.02em" }}>Built on HR legacy. Strengthened by global workplace practice.</h2>
          </Reveal>
      ...
      {/* TESTIMONIALS */}
      <div data-screen-label="Testimonials" style={{ background: "#f4f7f9", padding: "96px 48px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22 }}>
            {testimonials.map((t) => (
              <Reveal key={t.name} style={{ background: "#fff", border: "1px solid #e3eaf0", borderRadius: 18, padding: "30px 28px", display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ color: "#f5b942", fontSize: 16, letterSpacing: 2 }}>★★★★★</div>
                <p style={{ font: "400 14.5px/1.7 'Manrope',sans-serif", color: "#3d5064", margin: 0, flex: 1, textWrap: "pretty" } as CSSProperties}>“{t.quote}”</p>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 42, height: 42, borderRadius: "50%", background: "linear-gradient(135deg,#2fc4bc,#2f7fd6)", color: "#fff", font: "700 15px 'Space Grotesk',sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }}>{t.initials}</div>
                  <div>
          ...
          <div style={{ textAlign: "center", font: "600 11.5px monospace", color: "#8296a9", marginTop: 20 }}>placeholder testimonials — to be replaced with real participant feedback</div>
        </div>
      </div>
      ...
      <div data-screen-label="Gallery" style={{ background: "#fff", padding: "72px 0", overflow: "hidden" }}>
        <Reveal style={{ textAlign: "center", marginBottom: 40, padding: "0 48px" }}>
          ...
          <h2 style={{ font: "700 clamp(26px,2.8vw,36px)/1.15 'Space Grotesk',sans-serif", color: "#0a1b33", margin: 0, letterSpacing: "-.02em" }}>Sessions across campuses, conclaves and corporates</h2>
        </Reveal>
      ...
      <div data-screen-label="CTA" style={{ position: "relative", background: "#fff", padding: "40px 48px 110px", overflow: "hidden" }}>
        <Reveal style={{ position: "relative", maxWidth: 1100, margin: "0 auto", background: "linear-gradient(135deg,#0c2a45,#0a1f38)", border: "1px solid rgba(47,196,188,.35)", borderRadius: 26, padding: "64px 56px", textAlign: "center", overflow: "hidden", boxShadow: "0 30px 70px rgba(10,27,51,.25)" }}>
          ...
          <h2 style={{ position: "relative", font: "700 clamp(28px,3.2vw,42px)/1.2 'Space Grotesk',sans-serif", color: "#f2f7fb", margin: "0 0 16px", letterSpacing: "-.02em" }}>Ready to build workplace capability that lasts?</h2>
          <p style={{ position: "relative", font: "400 16px/1.7 'Manrope',sans-serif", color: "#a9bcd0", maxWidth: 620, margin: "0 auto 34px" }}>Partner with Levitate PeopleSoft for certification programs, customized training interventions and institutional learning solutions.</p>
          <div style={{ position: "relative", display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="#" className="lp-btn-grad" style={{ background: "linear-gradient(120deg,#2fc4bc,#2f7fd6)", color: "#04121f", font: "700 15px 'Manrope',sans-serif", padding: "16px 30px", borderRadius: 999 }}>Request a Training Proposal</a>
            <a href="#" className="lp-btn-outline-light" style={{ border: "1.5px solid rgba(255,255,255,.25)", color: "#e8f1f8", font: "700 15px 'Manrope',sans-serif", padding: "16px 30px", borderRadius: 999 }}>Book a Discovery Call</a>
          </div>
        </Reveal>
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1.2fr", gap: 48, marginBottom: 48 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, font: "500 13.5px 'Manrope',sans-serif" }}>
                {["Train-the-Trainer Certifications", "Corporate Training Solutions", "Institutional Training", "HR Advisory & Culture Consulting"].map((x) => (
                  <a key={x} href="#" className="lp-footlink">{x}</a>
                ))}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, font: "500 13.5px 'Manrope',sans-serif", color: "#5b6e82" }}>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 9 }}><MailIcon size={14} />{contact.email}</span>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 9 }}><PhoneIcon size={14} />{contact.phone}</span>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 9 }}><WhatsAppIcon size={14} />WhatsApp: {contact.phone}</span>
              </div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 12, marginTop: 18, background: "#fff", border: "1px solid rgba(27,143,136,.4)", borderRadius: 12, padding: "12px 16px" }}>
                <div style={{ width: 40, height: 40, flex: "none", borderRadius: "50%", border: "2px solid #2fc4bc", display: "flex", alignItems: "center", justifyContent: "center", font: "700 10px 'Space Grotesk',sans-serif", color: "#1b8f88", textAlign: "center", lineHeight: 1.1 }}>ISO</div>
                <div>
